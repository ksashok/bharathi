...
const Footer = () => {
    return (
        <footer style={{ background: 'var(--secondary)', color: 'white', padding: '4rem 0 2rem', marginTop: 'auto' }}>
            <div className="container">
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '3rem', marginBottom: '3rem' }}>

                    <div>
                        <h3 style={{ marginBottom: '1.5rem', fontSize: '1.5rem', color: 'white', fontWeight: '800' }}>Bharathi Academy</h3>
                    ...
                    <div>
                        ...
                        <ul style={{ display: 'flex', flexDirection: 'column', gap: '0.8rem' }}>
                            ...
                            <li><a href="/locations" style={{ color: 'rgba(255,255,255,0.8)' }}>Locations</a></li>
                            <li><a href="/fees" style={{ color: 'rgba(255,255,255,0.8)' }}>Enrolment</a></li>
                            <li><a href="/events" style={{ color: 'rgba(255,255,255,0.8)' }}>Events</a></li>
                        </ul>
                    </div>

                    <div>
                        <h3 style={{ marginBottom: '1.5rem', color: 'var(--accent)', fontSize: '1.1rem', textTransform: 'uppercase', letterSpacing: '1px' }}>Contact</h3>
                        <p style={{ marginBottom: '0.5rem', color: 'rgba(255,255,255,0.8)' }}>📞 +61 1300 933 922</p>
                        <p style={{ color: 'rgba(255,255,255,0.8)' }}>✉️ info@bharathi.org.au</p>
                    </div>
